...
const EmpowermentSection = () => {
  ...
  const features = [
    {
      ...
      icon: <MdForum className="text-white text-4xl sm:text-5xl" />,
    ...
    },
    {
      ...
      icon: <MdVisibility className="text-white text-4xl sm:text-5xl" />,
    ...
    },
    {
      ...
      icon: <MdDiversity3 className="text-white text-4xl sm:text-5xl" />,
  ...
  return (
    <section
      id="features"
      className="w-full bg-gradient-to-b from-gray-950 via-gray-950 to-black text-white py-24 px-4 sm:py-28"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className={`relative p-6 sm:p-8 rounded-3xl bg-white/5 border border-white/10 
                          backdrop-blur-md transition-all duration-300 
                          hover:scale-[1.02] hover:shadow-2xl ${feature.glow}`}
            >
              <div
                className={`w-16 h-16 sm:w-20 sm:h-20 mb-6 rounded-2xl flex items-center justify-center 
